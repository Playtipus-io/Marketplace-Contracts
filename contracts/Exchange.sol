...
contract Exchange is ExchangeCore {
    ...
    {
        return hashOrder(
            Order(addrs[0], addrs[1], addrs[2], addrs[3], addrs[4], addrs[5], uints[0], bytes(uri), uints[1], uints[2],
                  uints[3], uints[4])
        );
    }
    ...
    function validateOrderParameters_ (
        ...
        returns (bool)
    {
        Order memory order = Order(addrs[0], addrs[1], addrs[2], addrs[3], addrs[4], addrs[5], uints[0], bytes(uri),
    ...
    function ordersCanMatch_(
        ...
        returns (bool)
    {
        Order memory buy = Order(addrs[0], addrs[1], addrs[2], addrs[3], addrs[4], addrs[5], uints[0], bytes(uris[0]),
                                 uints[1], uints[2], uints[3], uints[4]);
        Order memory sell = Order(addrs[6], addrs[7], addrs[8], addrs[9], addrs[10], addrs[11], uints[5],
                                  bytes(uris[1]), uints[6], uints[7], uints[8], uints[9]);
        ...
        payable
    {
        ...
        return atomicMatch(
          Order(addrs[0], addrs[1], addrs[2], addrs[3], addrs[4], addrs[5], uints[0], bytes(uris[0]), uints[1],
                uints[2], uints[3], uints[4]),
          buyerSignature,
          Order(addrs[6], addrs[7], addrs[8], addrs[9], addrs[10], addrs[11], uints[5], bytes(uris[1]), uints[6],
